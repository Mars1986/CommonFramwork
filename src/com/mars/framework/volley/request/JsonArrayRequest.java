...
public class JsonArrayRequest extends JsonRequest<JSONArray> {
    ...
    /**
     * JsonArray 不带参数的请求(默认GET方法).
     * @param url URL to fetch the JSON from
     * @param listener Listener to receive the JSON response
     * @param errorListener Error listener, or null to ignore errors.
     */
    public JsonArrayRequest(String url, Map<String, String> requestParmas,Listener<JSONArray> listener, ErrorListener errorListener) {
        this(Method.GET, url, null, listener, errorListener);
    }
    
    /**
     * JsonArray 带参数的请求(默认GET方法).
     * @param url URL to fetch the JSON from
     * @param listener Listener to receive the JSON response
     * @param errorListener Error listener, or null to ignore errors.
     */
    public JsonArrayRequest(int method,String url,Map<String, String> requestParmas, Listener<JSONArray> listener, ErrorListener errorListener) {
        super(Method.GET, url, requestParmas, listener, errorListener);
    }
