...
public class JsonObjectRequest extends JsonRequest<JSONObject> {
     ...
     */
    public JsonObjectRequest(int method, String url,  Map<String, String> requestParmas,
            Listener<JSONObject> listener, ErrorListener errorListener) {
        super(method, url, requestParmas, listener,
                    errorListener);
    }
     ...
     */
    public JsonObjectRequest(String url, Map<String, String> requestParmas, Listener<JSONObject> listener,
            ErrorListener errorListener) {
        this(requestParmas == null ? Method.GET : Method.POST, url, requestParmas,
